...
type (
	...
	// annotations inherited from Talos practices (i.e. audit/enforce/warn versions
	// to latest, audit/warn to restricted and enforce to baseline).
	//
...
func NewNamespace(
	...
	if err := ctx.RegisterComponentResource("ctfer-io:fullchain:namespace", name, ns, opts...); err != nil {
		return nil, err
	}
